		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
					...
					<a href="prurezT.php"  class='tagButton' id='prurezTmain'><img src="images/T_zelena_200x200px.png" alt="Průřez T"></a>
				...
				<form class="zadaniPrurezu" id="T">
					<div id="AB">
                    	...
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_T_schema_600x600px.png" alt="Obrázek průřezu tvaru T">
						</div>
					</div>
					<div class="vysledky">
