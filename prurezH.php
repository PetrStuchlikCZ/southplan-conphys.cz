		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
                    ...
                    <a href="prurezH.php"  class='tagButton' id='prurezHmain'><img src="images/H_zelena_200x200px.png" alt="Průřez H"></a>
					...
					<a href="prurezO.php"  class='tagButton' id='prurezO'><img src="images/O_200x200px.png" alt="Průřez O"></a>
					<a href="prurezTram.php"  class='tagButton' id='prurezTram'><img src="images/Trám_200x200px.png" alt="Průřez Trám"></a>
				</section>
				<form class="zadaniPrurezu" id="H">
					<div id="AB">
						<div class="vstup">
                    		<div id="sirkaVyska">
								<div class="inputSV">
									<label for="sirka">Šířka průřezu (a)</label><br>
									<input type="number" placeholder="" id="sirka" name="sirka" value="" required>
								</div>
								<div class="inputTl">
									<label for="vyska1">Výška průřezu (h1)</label><br>
									<input type="number" placeholder="" id="vyska1" name="vyska1" value="" required>
								</div>
								<div class="inputTl">
									<label for="vyska2">Výška průřezu (h2)</label><br>
									<input type="number" placeholder="" id="vyska2" name="vyska2" value="" required>
								</div>
							</div>
							<div class="inputTlU">
								<label for="tloustka">Tloušťka spojnice (c)</label><br>
								<input type="number" placeholder="" id="tloustka" value="" name="tloustka" required>
							</div>
							<div id="sirkaVyska">
								<div class="inputPas">
									<label for="vyskaB1">Šířka stojiny (b1)</label><br>
									<input type="number" placeholder="" id="vyskaB1" name="vyskaB1" value="" required>
								</div>
								<div class="inputPas">
									<label for="vyskaB2">Šířka stojiny (b2)</label><br>
									<input type="number" placeholder="" id="vyskaB2" name="vyskaB2" value="" required>
								</div>
							</div>
						</div>
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_H_schema_600x600px.png" alt="Obrázek průřezu tvaru H">
						</div>
					</div>
					<div class="vysledky">
