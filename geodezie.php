...
<?php include "assets/analytics.php"; ?>
	...
	<title>Geodézie | Southplan</title>
</head>
<body>
<!-- HLAVIČKA -->
    <header>
...
<main> 
	<section class="nahled" <?php if($permission_geodezie == "off"){
		...
		<?php else: ?>
        <?php include "assets/icons-crossroadGeodezie.php"; ?>
		
		<section class="formVrstevnice">
			<section id="buttonTags">
				<a href="geodezieVyska.php" class='tagButton' id='vypocetVysky'><h2>Výpočet výšky</h2></a>
				<a href="geodezieVzdalenost.php"  class='tagButton' id='vypocetVzdalenosti'><h2>Výpočet vzdálenosti</h2></a>
			</section>
		...
		<section class="formKubatury">
		<section id="buttonTags">
				<div class='tagButton2' id='vypocetVysky'><h2>Výpočet kubatur</h2></div>
			</section>
		<form id="zadaniKubatur">
			<div id="AB2">
				<div id="ABCDEF">
					<div id="podstavaAB">
						<div class="inputKubatury">
							<label for="podstavaA">Strana podstavy A</label><br>
							<input type="number" placeholder="" id="podstavaA" name="podstavaA" value="" required>
						</div>
						<div class="inputKubatury">
							<label for="podstavaB">Strana podstavy B</label><br>
							<input type="number" placeholder="" id="podstavaB" name="podstavaB" value="" required>
						</div>
					</div>
					<div id="vyskyCD">
						<div class="inputKubatury">
							<label for="vyskaC">Výška C</label><br>
							<input type="number" placeholder="" id="vyskaC" name="vyskaC" value="" required>
						</div>	
						<div class="inputKubatury">
							<label for="vyskaD">Výška D</label><br>
							<input type="number" placeholder="" id="vyskaD" name="vyskaD" value="" required>
						</div>
					</div>
					<div id="vyskyEF">
						<div class="inputKubatury">
							<label for="vyskaE">Výška E</label><br>
							<input type="number" placeholder="" id="vyskaE" name="vyskaE" value="" required>
						</div>
						<div class="inputKubatury">
							<label for="vyskaF">Výška F</label><br>
							<input type="number" placeholder="" id="vyskaF" name="vyskaF" value="" required>
						</div>
					</div>
				
					<!-- tady bude obrazek -->
				</div>
					<div class="ilustrace2">
						<img id="imgPodstava" src="images/Podstava_kubatury_450x450px.png">
						<img id="imgObjem" src="images/Objem_kubatury_450x450px.png">
					</div>
			</div>
				<div id="vysledek">
					<div class="inputV">
						<label for="vzdalenostAB">Objem</label><br>
						<input type="number" placeholder="" id="objem" value="" name="objem">
					</div>
				</div>
			</form>
			<div id="chyby">
...
<?php 
	...
	<script src="javaScript/scriptGeodezie.js"></script>
</body>
</html>