		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
                    ...
                    <a href="prurezN.php"  class='tagButton' id='prurezNmain'><img src="images/N_zelena_200x200px.png" alt="Průřez obrácené U"></a>
				...
				<form class="zadaniPrurezu" id="N">
					<div id="ABU">
						<div class="vstup">
                    		<div id="sirkaVyska">
								<div class="inputSV">
									<label for="sirka1">Šířka průřezu (a)</label><br>
							...
							<div id="sirkaVyska">
								<div class="inputTlU">
									<label for="tloustka1">Tloušťka stojiny (c1)</label><br>
									<input type="number" placeholder="" id="tloustka1" value="" name="tloustka1">
								</div>
								<div class="inputTlU">
									<label for="tloustka2">Tloušťka stojiny (c2)</label><br>
									<input type="number" placeholder="" id="tloustka2" value="" name="tloustka2">
								</div>
							</div>
							<div id="sirkaVyska">
								<div class="inputSV">
									<label for="vyskaV1">Výška pásnice (v)</label><br>
                    	...
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_N_schema_600x600px.png" alt="Obrázek průřezu tvaru obráceného U">
						</div>
					</div>
					<div class="vysledky">
