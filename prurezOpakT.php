		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
                    ...
                    <a href="prurezOpakT.php" class='tagButton' id='prurezOpakTmain'><img src="images/Opak_T_zelena_200x200px.png" alt="Průřez obrácené T"></a>
				...
				<form class="zadaniPrurezu" id="OpakT">
					<div id="AB">
						<div class="vstup">
                    		<div id="sirkaVyska">
								<div class="inputSV">
                    	...
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_OpakT_schema_600x600px.png" alt="Obrázek průřezu tvaru obráceného T">
						</div>
					</div>
					<div class="vysledky">
