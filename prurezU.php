		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
                    ...
                    <a href="prurezU.php"  class='tagButton' id='prurezUmain'><img src="images/U_zelena_200x200px.png" alt="Průřez U"></a>
				...
				<form class="zadaniPrurezu" id="U">
					<div id="ABU">
						<div class="vstup">
							...
							<div id="sirkaVyska">
								<div class="inputTlU">
									<label for="tloustka">Tloušťka stojiny (c1)</label><br>
									<input type="number" placeholder="" id="tloustka1" value="" name="tloustka">
								</div>
								<div class="inputTlU">
									<label for="tloustka">Tloušťka stojiny (c2)</label><br>
									<input type="number" placeholder="" id="tloustka2" value="" name="tloustka">
								</div>
							</div>
							<div id="sirkaVyska">
								<div class="inputSV">
                    	...
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_U_schema_600x600px.png" alt="Obrázek průřezu tvaru U">
						</div>
					</div>
					<div class="vysledky">
