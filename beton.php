		...
		<?php if($permission_beton == "off"): ?>
				<section id='sentSuccess'>
					<div class="wait">
						...
						<h3>Zde pro vás připravujeme stránku pro online návrh betonových prvků</h3>
					</div>
				</section>
		<?php else: ?>
        <?php include "assets/icons-crossroadBeton.php"; ?>
		<?php endif ?>
    </section>
</main>
<!-- PATIČKA -->
