<footer>
		<nav class="dolni">
			<!-- <?= "<form action='accesories/addEmail.php?from=$from' method='POST' id='formAddEmailMobil' enctype='multipart/form-data'>" ?>
			...
			<ul>
				...
				if($permission_postup == "off"){
					...
					$li_postup = "<li><a href='accesories/howTo.php'>Postup zadání nezávazné poptávky</a></li>";
				}
				if($permission_cenik == "off"){
					$li_cenik = "";
				} elseif ($permission_cenik == "on"){
					$li_cenik = "<li><a href='accesories/cenik.php'>Ceník</a></li>";
				}
				if($permission_kontakt == "off"){
					$li_kontakt = "";
				} elseif ($permission_kontakt == "on"){
					$li_kontakt = "<li><a href='accesories/kontakt.php'>Kontakt</a></li>";
				}
				if($permission_oNas == "off"){
					$li_oNas = "";
				} elseif ($permission_oNas == "on"){
					$li_oNas = "<li><a href='accesories/oNas.php'>O nás</a></li>";
				}
				if($permission_podminky == "off"){
					$li_podminky = "";
				} elseif ($permission_podminky == "on"){
					$li_podminky = "<li><a href='accesories/podminky.php'>Podmínky</a></li>";
				}
			...
			<!-- <?= "<form action='accesories/addEmail.php?from=$from' method='POST' id='formAddEmail' enctype='multipart/form-data'>" ?>
				<p id="addEmailP">Přejete si odebírat newsletter?</p>
				<div class="tooltip-container">
					<input type="email" id="inputEmail" placeholder="E-mail" name="email">
