		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
					...
					<a href="prurezTram.php"  class='tagButton' id='prurezTrammain'><img src="images/Trám_zelena_200x200px.png" alt="Průřez Trám"></a>
				</section>
                <form class="zadaniPrurezu" id="Tram">
					<div id="AB">
						<div class="vstup">
                    		<div id="sirkaVyska">
								<div class="inputSV">
									<label for="sirka">Šířka (a)</label><br>
									<input type="number" placeholder="" id="sirka" name="sirka" value="" required>
								</div>
								<div class="inputTl">
									<label for="vyska">Výška (h)</label><br>
                    	...
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_Trám_schema_600x600px.png" alt="Obrázek průřezu tvaru obdélníku">
						</div>
					</div>
					<div class="vysledky">
