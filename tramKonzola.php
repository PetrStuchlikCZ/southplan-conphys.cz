		...
		<?php if($permission_statika == "off"): ?>
				<section id='sentSuccess'>
					<div class="wait">
						...
						<h3>Zde pro vás připravujeme stránku pro online návrh betonových prvků - trámu s konzolou</h3>
					</div>
				</section>
		<?php else: ?>
            <section class="formBeton">
                <form class="zadaniTramu" id="tramKonzola">
                        <div id="AB">
                            <div class="vstup">
                                <div id="sirkaVyska">
                                    <div class="inputSVk">
                                        <label for="rozpetiL">Délka trámu L₁ [m]</label><br>
                                        <input type="number" placeholder="" id="rozpetiL" name="rozpetiL" value="" required>
                                    </div>
                                </div>
                                <div id="sirkaVyska">
                                    <div class="inputSVk">
                                        <label for="rozpetiLk">Délka konzole L₂ [m]</label><br>
                                        <input type="number" placeholder="" id="rozpetiLk" name="rozpetiLk" value="" required>
                                    </div>
                                </div>
                                ...
                                <div id="sirkaVyska">
                                    ...
                                    <div class="inputPas">
                                        <label for="staleK">Stálé na konzole</label><br>
                                        <input type="number" placeholder="" id="staleK" name="staleK" value="" required>
                                    </div>
                                    <div class="inputPas">
                                    ...
                                    <div class="inputPas">
                                        <label for="zabradli">Síla od zábradlí</label><br>
                                        <input type="number" placeholder="" id="zabradli" name="zabradli" value="" >
                                    </div>
                                </div>
                            </div>
                            <!-- tady bude obrazek -->
                            <div class="ilustrace">
                                <img id="imgVrstevnice" src="" alt="Obrázek betonového trámu s konzolou">
                            </div>
                        </div>
                        <div class="vysledky">
                            <h3><strong>Geometrie</strong></h3>
                            <h2 id="rozpetiVyska">Rozpětí výšky trámu</h2>
                            <div id="sirkaVyska">
                            <div class="inputSV">
                            ...
                            <h2 id="rozpetiSirka">Rozpětí šířky trámu</h2>
                            <div id="sirkaVyska">
                                    <div class="inputSV">
                                        <label for="sirkaB">Šířka b</label><br>
                                        <input type="number" placeholder="" id="sirkaB" name="sirkaB" value="" required>
                                    </div>
						    </div>
                            ...
                            <div id="sirkaVyska">
                                    ...
                                    <div class="inputMax">
                                        <label for="Mp">Moment nad podporou</label><br>
