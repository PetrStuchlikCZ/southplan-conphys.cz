		...
		<?php if($permission_statika == "off"): ?>
				<section id='sentSuccess'>
					<div class="wait">
						...
						<h3>Zde pro vás připravujeme stránku pro online návrh betonových prvků - prostého trámu</h3>
					</div>
				</section>
		<?php else: ?>
            <section class="formBeton">
                <form class="zadaniTramu" id="tramProsty">
                        <div id="AB">
                            <div class="vstup">
                                <div id="sirkaVyska">
                                    <div class="inputSV">
                                        <label for="rozpetiL">Délka L [m]</label><br>
                                ...
                                <div id="sirkaVyska">
                                    ...
                                    <div class="inputPas">
                                        <label for="stale">Stálé</label><br>
                            ...
                            <!-- tady bude obrazek -->
                            <div class="ilustrace">
                                <img id="imgVrstevnice" src="" alt="Obrázek prostě uloženého trámu">
                            </div>
                        </div>
                        <div class="vysledky">
