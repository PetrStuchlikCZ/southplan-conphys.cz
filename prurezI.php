		...
		<?php else: ?>
            <section class="formPrurezy">
                <section id="buttonTagsPrurezy">
                    <a href="prurezI.php" class='tagButton' id='prurezImain'><img src="images/I_zelena_200x200px.png" alt="Průřez I"></a>
                ...
                <form class="zadaniPrurezu" id="I">
					<div id="AB">
						<div class="vstup">
                    		<div id="sirkaVyska">
								<div class="inputSV">
									<label for="sirka1">Šířka průřezu (a1)</label><br>
									<input type="number" placeholder="" id="sirka1" name="sirka1" value="" required>
								</div>
								<div class="inputSV">
									<label for="sirka2">Šířka průřezu (a2)</label><br>
									<input type="number" placeholder="" id="sirka2" name="sirka2" value="" required>
								</div>
								<div class="inputSV">
									<label for="vyska">Výška průřezu (h)</label><br>
									<input type="number" placeholder="" id="vyska" name="vyska" value="" required>
								</div>
							</div>
							<div class="inputTl">
								<label for="tloustka">Tloušťka stojiny (c)</label><br>
								<input type="number" placeholder="" id="tloustka" value="" name="tloustka">
							</div>
							<div id="sirkaVyska">
								<div class="inputPas">
									<label for="vyskaV1">Výška pásnice (v1)</label><br>
									<input type="number" placeholder="" id="vyskaV1" name="vyskaV1" value="" required>
								</div>
								<div class="inputPas">
									<label for="vyskaV2">Výška pásnice (v2)</label><br>
									<input type="number" placeholder="" id="vyskaV2" name="vyskaV2" value="" required>
								</div>
							</div>
						</div>
                    	<!-- tady bude obrazek -->
						<div class="ilustrace">
							<img id="imgVrstevnice" src="images/Průřez_I_schema_600x600px.png" alt="Obrázek průřezu tvaru I">
						</div>
					</div>
					<div class="vysledky">
